...
class SpaceJam(ShowBase):
    ...
    def SetScene(self):
        ...
        #project 8
        self.Wanderer1=SpaceClass.Wanderer(self.loader,self.rootAssetFolder+"/DroneDefender/DroneDefender.obj",self.render,# type: ignore
            "Drone",10.0,self.rootAssetFolder+"/DroneDefender/octotoad1_auv.png",self.Hero)# type: ignore
        
        self.Wanderer2=SpaceClass.Wanderertwo(self.loader,self.rootAssetFolder+"/DroneDefender/DroneDefender.obj",self.render,# type: ignore
            "Drone",10.0,self.rootAssetFolder+"/DroneDefender/octotoad1_auv.png",self.Hero)# type: ignore
        
        self.Follower1=SpaceClass.Follower(
            self.loader,self.taskMgr,self.rootAssetFolder+"/DroneDefender/DroneDefender.obj",self.render,# type: ignore
            "Follower1",10.0,self.rootAssetFolder+"/DroneDefender/octotoad1_auv.png",self.Hero,500,self.Hero)# type: ignore
